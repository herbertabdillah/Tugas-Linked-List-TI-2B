...
//            SqlConnection.setLogin("jdbc:mysql://localhost:9993/ppdbSmanDepok", "herbiejago", "sudo");
    ...
    public FrameSiswa() {
        ...
        LFSiswa.imporDb();
        initComponents();
        TFNama.setText(LFSiswa.nama);
        TFNilai.setText(LFSiswa.nilai);
        textPane1.setText(LFSiswa.namaSekolah);
        if(LFSiswa.pilihan.get(0) != null){
            CBPil1.setSelectedIndex(LFSiswa.pilihan.get(0));
        }
        if(LFSiswa.pilihan.get(1) != null){
            CBPil1.setSelectedIndex(LFSiswa.pilihan.get(1));
        }
        if(LFSiswa.pilihan.get(0) != null){
            CBPil1.setSelectedIndex(LFSiswa.pilihan.get(2));
        }
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        CBPil2.setModel(new javax.swing.DefaultComboBoxModel(arraySekolah.toArray()
        ));

        CBPil3.setModel(new javax.swing.DefaultComboBoxModel(arraySekolah.toArray()
        ));
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(TFNisn, javax.swing.GroupLayout.PREFERRED_SIZE, 106, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addGroup(layout.createSequentialGroup()
                                .addContainerGap()
                                .addComponent(LNama)
                                .addGap(41, 41, 41)
...
//        textPane1.setText(pilihan1);
        int pil1 = CBPil1.getSelectedIndex();
        int pil2 = CBPil2.getSelectedIndex();
        int pil3 = CBPil3.getSelectedIndex();
        LFSiswa.setPilihan(pil1, pil2, pil3);
